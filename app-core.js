// === SELF-HEALING BOOTSTRAP (no user action required) ===
// If GitHub Pages serves an older cached index or script order changes,
// we still guarantee APP_CONFIG and PHONICS_DATA exist before the core runs.
(function(){
  try {
    ...
    // last resort: keep going; core will show a readable error if data is missing
